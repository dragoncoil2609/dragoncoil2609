...
CloudOps/DevOps Intern @ XBrain x AWS | AWS Solutions Architect Aspirant

- 🚀 Passionate about CI/CD pipelines, containerization, and cloud infrastructure.
- 🛠 Currently working on: Building proactive observability platforms & automating cloud infrastructure.
- 📚 Studying for: AWS Certified Solutions Architect – Associate (SAA-C03).
- 💬 Ask me about: Linux administration, AWS, Terraform, and Jenkins.
